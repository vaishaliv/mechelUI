...
import EditInitialBody from "./EditInitialBody";

const EditNewCustomer = ({ customerData, handleClose }) => {
  const machineData = customerData?.sales_machineDetails;
  const serviceData = customerData?.service_contract_details;
  const calibrationData = customerData?.calibration_contract_details;

  const [editedMachineData, setEditedMachineData] = useState(machineData);
  const [editedServiceData, setEditedServiceData] = useState(serviceData);
  const [editedCalibrationData, setEditedCalibrationData] =
    useState(calibrationData);
  ...
  console.log("Edit New CustomerList....", customerData);
  ...
  const data = [
    ...
    //   id: 1,
    //   head: "Machine Screen",
    //   body: <EditMachineBody editedMachine={machineData} />,
    //   foot: (
    //     <EditMachineFooter
    //       handleClose={handleClose}
    //       handleSubmit={handleMachineSubmit}
    ...
    //   id: 2,
    //   head: "Service Screen",
    //   body: <EditServiceBody editedServiceData={serviceData} />,
    //   foot: (
    //     <AddServiceFooter
    //       handleClose={handleClose}
    ...
    //   body: <EditCalibrationBody editedCalibrationData={calibrationData} />,
    //   foot: (
    //     <EditCalibrationFooter
    //       handleClose={handleClose}
    ...
    <Container className="" style={{ color: "aliceblue" }}>
      <div>
        ...
        {/* <div
          ...
          style={{ backgroundColor: "skyblue", border: 0, outline: 0 }}
        >
          <Button>X</Button>
        </div> */}
        <Card
