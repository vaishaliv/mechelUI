...
export const AddServiceForm = ({
  ...
  const [amcStartDate, setAmcStartDate] = useState(null);
  const [amcEndDate, setAmcEndDate] = useState(null);
  ...
  const handleSubmit = (event) => {
    ...
    setNewService(initialObj);
    console.log(initialObj, "Add Service Form initialObj");
    ...
    if (selectedCustomer) {
      ...
      // const count =
      //   copiedPageData[indexCustomer].service_contract_details.length;
      const newServiceWithId = { ...initialObj, id: generateId() };
      const serviceArray = [
        ...copiedPageData[indexCustomer].service_contract_details,
        newServiceWithId,
      ];
      copiedPageData[indexCustomer].service_contract_details = serviceArray;
    }
  ...
  console.log("Add Service Form.....", pageData);
