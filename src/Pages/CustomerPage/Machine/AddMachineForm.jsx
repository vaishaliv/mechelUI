...
export const AddMachineForm = ({
  ...
  const handleSubmit = (event) => {
    ...
    if (selectedCustomer) {
      ...
      // const count = copiedPageData[indexCustomer].sales_machineDetails.length;
      const newMachineWithId = { ...initialObj, id: generateId() };
      const machineArray = [
        ...copiedPageData[indexCustomer].sales_machineDetails,
        newMachineWithId,
      ];
      copiedPageData[indexCustomer].sales_machineDetails = machineArray;
    }
    console.log(
      "MACHINE tABLE ADD .....",
      newMachine,
  ...
  console.log("count ....Add Machine Form.....", newMachine);

  // console.log("Add Machine Form.....", salesDate, body);
  return (
    <Form
      className="px-2"
      // noValidate
